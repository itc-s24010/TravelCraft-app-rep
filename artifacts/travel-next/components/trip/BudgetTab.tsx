        ...
        {showForm && (
          <form onSubmit={handleCreate} className="flex gap-2 mb-4 flex-wrap">
            <select required value={form.categoryId} onChange={(e) => setForm({ ...form, categoryId: e.target.value })}
              className="flex-1 min-w-[120px] px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50">
            ...
            <input required type="number" min="0" value={form.budgetAmount}
              ...
              className="w-32 px-3 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
              placeholder="金額 (¥)" />
